...
DATASET=dbpedia_entity_500k
EMBEDDING_MODEL="cohere_v4"
BASE_FILE_NAME=base.bin
QUERY_FILE_NAME=query.bin
RUN_NAME=${RUN_NAME:-chunks_buckets_8_init_8_inc_8_max_192_sampl_01_bytes_384}
...
RUN_DIR=/home/jam1729/runs/pq_search_runs/${DATASET}/${EMBEDDING_MODEL}/${RUN_NAME}
